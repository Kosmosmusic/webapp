...
import { getTracksOptions } from '../../interfaces/soundcloud/soundcloud-api-options.interface';
import { ISoundcloudMe } from '../../interfaces/soundcloud/soundcloud-me.config';
import { ISoundcloudInitOptions } from '../../interfaces/soundcloud/soundcloud-options.config';
...
import { ISoundcloudTrack } from '../../interfaces/soundcloud/soundcloud-track.config';
import {
...
export class AppSoundcloudApiService implements OnDestroy {
  /**
  ...
  public ngOnDestroy(): void {
    ...
    void this.store.dispatch(new soundcloudActions.setSoundcloudState({ tracks, playlists }));
  }
}

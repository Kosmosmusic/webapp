...
describe('TranslateService dictionary: lang-en', () => {
  it('should have translations defined', () => {
    ...
    expect(LANG_EN_TRANSLATIONS).toEqual(
      jasmine.objectContaining({
        ...
        services: {
          ...
          paragraph3:
            'Individual approach to each recording is our way to achive the best possible results.',
          requirements:
            'Technical requirements: 320 mp3/kbps, full length version, file naming format: atrist_name - track_name (your_email@domain.tld).',
        },
        demo: {
          open: 'Send demo',
